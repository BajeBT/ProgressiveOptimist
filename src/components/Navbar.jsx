...
export const Navbar = ({ onOpenPostModal }) => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 dark:bg-slate-950/95 backdrop-blur-md shadow-sm border-b border-slate-200 dark:border-slate-800 transition-colors duration-300">
      ...
      {isSandboxMode && (
        <div className="bg-amber-400 text-slate-950 text-[11px] font-semibold py-1 px-4 text-center border-b border-amber-500 shadow-sm flex items-center justify-center gap-2">
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3 shrink-0">
            ...
            {isSandboxMode && dbConnected && (
              <span className="hidden sm:inline-flex items-center gap-1 font-bold text-[10px] px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-300 border border-emerald-500/30">
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-3">
            ...
            {currentUser ? (
              ...
              <Link
                to="/membership"
                className="flex items-center space-x-1.5 bg-orange-500 hover:bg-orange-600 text-white px-4 py-2.5 rounded-xl font-bold text-xs shadow-md transition-all border border-orange-400/40 hover:scale-105"
              >
        ...
        <div className="bg-slate-100/80 dark:bg-slate-900 border-t border-b border-slate-200 dark:border-slate-800 py-2.5">
          <div className="max-w-7xl mx-auto flex items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto">
              ...
              <Link
                to="/membership"
                className="flex items-center space-x-2 bg-amber-500 hover:bg-amber-600 text-slate-950 px-3 py-1.5 rounded-xl font-bold text-xs shadow transition-all shrink-0"
              >
                <img
